...
public class WhereInQFunction extends Function{
    ...
    private String res = "";//krajnji rez je formata npr: where job_id in; znaci bez zagrada i uopste celog naziva subquery-ja;to se setuje u compiler-u
    private String pattern_part1 = "WHERE ";
    private String pattern_part2 = "IN ";
